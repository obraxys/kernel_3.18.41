/usr/bin/arm-linux-gnueabi-gcc -E -Wp,-MD,m502_user.dtb.d.pre.tmp -nostdinc -I./arch/arm/boot/dts -I./arch/arm/boot/dts/include -I./include/ -I./drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o m502_user.dtb.dts.tmp m502_user.dts
